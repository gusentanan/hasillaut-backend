  ...
  require_once('./loader.php');
   ...
   // $adminFeature->AddProduct();
    ...
    if(isset($_POST['insert'])){
      ...
      if($fotoProduk){
        $adminFeature->AddProduct($fotoProduk, $namaProduk, $hargaProduk, $deskripsiProduk, $kategoriProduk, $kodeProduk);
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <a role="button" href="adminPage.php" style="border-color: #4ADEDE; background-color: white; color: #4ADEDE;  text-align: left; " class="btn"> <i style="width: 7%; height: 50%; margin-top: 2%; margin-left: 1%;" class="fas fa-user-circle fa-lg"></i> Akun Saya</a>
                  ...
                  <a role="button" href="addProduct.php" style="border-color: #4ADEDE; background-color: #4ADEDE; color: white; margin-top: 4%;   text-align: left;" class="btn"><i style="width: 10%; height: 50%;" class="far fa-plus-square"></i>Tambah Produk</a>
                 ...
                 <?php endif; ?>
                      ...
                      <form style="margin-left: 5%; margin-right: 5%;" id="update_form" method="post" enctype="multipart/form-data">
                          ...
                          <div>
                            ...
                            <input type="text" class="form-control" name="nama_produk" id="product_name" placeholder="Enter Product Name"  required>
                           </div>
                            <div>
                            ...
                            <div>
                              ...
                              <input type="text" class="form-control" id="product_price" name="harga_produk" placeholder="Masukkan Harga Produk" required/>
                            </div>
                             <div>
                              <label>Deskripsi Produk</label>
                               <textarea type="text" class="form-control" id="product_qty" name="deskripsi_produk" placeholder="Deskripsi Produk" required></textarea>
                            </div>
                            <div class="mb-3">
                              <label for="formFile" class="form-label">Produk Foto</label>
                               <td><input class="input-group" type="file" name="foto_produk" accept="image/*"/></td>
                            </div>
                            <button type="submit" name="insert" style="border-color:#4ADEDE; background-color: #4ADEDE; color: white; margin-top: 3%;" class="btn">Tambahkan Produk</button>
