            ...
            <div class="row">
              <div class="col-md-4">
                <div style="width: 80%;" class="btn-group-vertical">
                  <a role="button" href="adminPage.php" style="border-color: #4ADEDE; background-color: #4ADEDE; color: white;  text-align: left; " class="btn"> <i style="width: 7%; height: 50%; margin-top: 2%; margin-left: 1%;" class="fas fa-user-circle fa-lg"></i> Akun Saya</a>
              ...
              <div class="col-md-8">
                  <div class="countainer">
                    <?php if (isset($currentUser['admin_id'])): ?>
                      ...
                      <h6>Profil</h6>
                      <div class="wrapper">
                        <img class="circular--square" src="styles/img/admin.png"/>
                      </div>
                        <h6>username</h6>
                      <p class="card-text fw-bold" style="font-size: 100%;" ><?php echo $currentUser['username_admin']?></p>
                      <h6>Email</h6>
                      <p class="card-text fw-bold" style="font-size: 100%;" ><?php echo $currentUser['email_admin']?></p>
