<?php  
  ...
  $allOrder = $order->getOrdersByID($cartID['cart_id']);
        ...
        <div class="container">
            <div class="row">
              <div class="col-md-4">
                ...
                <a role="button" href="userHistory.php" style="border-color: #4ADEDE; background-color: #4ADEDE; color: white; margin-top: 4%;   text-align: left;" class="btn"><i style="width: 10%; height: 50%;" class="fas fa-box-open fa-lg"></i>Pesanan</a>
